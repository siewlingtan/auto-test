Feature: Login
	...
	Scenario Outline: test the whole kss system with different access
		...
		When I follow "Modules"
			...
			Then I press "Search"
			And I wait for "15" seconds until I see "10532"
			Then I wait until 10 seconds to click the magnifying glass on the row "10532" (title="View" class="view")
			And I sleep for "2" seconds
			And I wait for "5" seconds until I see "View Module Instance"
			When I fill in "Contact ID" with "CT0221060"
			When I wait for "2" seconds to click the button "Search"
			Then I wait for "5" seconds until I see "Esther Chua Kin San"
			And I sleep for "2" seconds
